...
class PrivacyScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => LaunchConfig.privacyNotice.isNotEmpty
      ? const PublicInformationPage(
          title: 'Privacy',
          summary: LaunchConfig.organizationName,
          sections: [
            PublicInformationSection(
              title: 'Privacy notice',
              paragraphs: [LaunchConfig.privacyNotice],
            ),
          ],
        )
      : const PublicInformationPage(
...
class TermsScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => LaunchConfig.termsNotice.isNotEmpty
      ? const PublicInformationPage(
          title: 'Terms',
          summary: LaunchConfig.organizationName,
          sections: [
            PublicInformationSection(
              title: 'Terms of use',
              paragraphs: [LaunchConfig.termsNotice],
            ),
          ],
        )
      : const PublicInformationPage(
